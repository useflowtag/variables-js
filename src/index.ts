...
export function createClient(token: string) {
  return {
    ...
    getVariableMeta: async (id: string): Promise<Omit<z.infer<typeof ValueSchema>, "value">> => {
 ...
 */
export async function getVariable<T extends VariableValue>(id: string): Promise<T> {
